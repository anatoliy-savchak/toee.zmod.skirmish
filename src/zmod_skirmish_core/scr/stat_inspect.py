...
class StatInspect:
	...
	def build(self):
		...
		self.stats["skill_name_dic_ranks"] = self.get_skill_name_dic_ranks()
	...
	def get_skill_name_dic_ranks(self):
		result = dict()
		result["Appraise"] = self.npc.skill_ranks_get(toee.skill_appraise)
		result["Bluff"] = self.npc.skill_ranks_get(toee.skill_bluff)
		result["Concentration"] = self.npc.skill_ranks_get(toee.skill_concentration)
		result["Diplomacy"] = self.npc.skill_ranks_get(toee.skill_diplomacy)
		result["Disable Device"] = self.npc.skill_ranks_get(toee.skill_disable_device)
		result["Gather Information"] = self.npc.skill_ranks_get(toee.skill_gather_information)
		result["Heal"] = self.npc.skill_ranks_get(toee.skill_heal)
		result["Hide"] = self.npc.skill_ranks_get(toee.skill_hide)
		result["Intimidate"] = self.npc.skill_ranks_get(toee.skill_intimidate)
		result["Listen"] = self.npc.skill_ranks_get(toee.skill_listen)
		result["Move Silently"] = self.npc.skill_ranks_get(toee.skill_move_silently)
		result["Open Lock"] = self.npc.skill_ranks_get(toee.skill_open_lock)
		result["Pick Pocket"] = self.npc.skill_ranks_get(toee.skill_pick_pocket)
		result["Search"] = self.npc.skill_ranks_get(toee.skill_search)
		result["Sense Motive"] = self.npc.skill_ranks_get(toee.skill_sense_motive)
		result["Spellcraft"] = self.npc.skill_ranks_get(toee.skill_spellcraft)
		result["Spot"] = self.npc.skill_ranks_get(toee.skill_spot)
		result["Tumble"] = self.npc.skill_ranks_get(toee.skill_tumble)
		result["Use Magic Devic"] = self.npc.skill_ranks_get(toee.skill_use_magic_device)
		#result["Wilderness Lore"] = self.npc.skill_ranks_get(toee.skill_wilderness_lore)
		result["Perform"] = self.npc.skill_ranks_get(toee.skill_perform)
		#result["Alchemy"] = self.npc.skill_ranks_get(toee.skill_alchemy)
		result["Balance"] = self.npc.skill_ranks_get(toee.skill_balance)
		result["Climb"] = self.npc.skill_ranks_get(toee.skill_climb)
		#result["Craft"] = self.npc.skill_ranks_get(toee.skill_craft)
		result["Decipher Script"] = self.npc.skill_ranks_get(toee.skill_decipher_script)
		#result["Disguise"] = self.npc.skill_ranks_get(toee.skill_disguise)
		result["Escape Artist"] = self.npc.skill_ranks_get(toee.skill_escape_artist)
		#result["Forgery"] = self.npc.skill_ranks_get(toee.skill_forgery)
		#result["Handle Animal"] = self.npc.skill_ranks_get(toee.skill_handle_animal)
		#result["Innuendo"] = self.npc.skill_ranks_get(toee.skill_innuendo)
		#result["Intuit Direction"] = self.npc.skill_ranks_get(toee.skill_intuit_direction)
		result["Jump"] = self.npc.skill_ranks_get(toee.skill_jump)
		result["Knowledge Arcana"] = self.npc.skill_ranks_get(toee.skill_knowledge_arcana)
		result["Knowledge Religion"] = self.npc.skill_ranks_get(toee.skill_knowledge_religion)
		result["Knowledge Nature"] = self.npc.skill_ranks_get(toee.skill_knowledge_nature)
		result["Knowledge All"] = self.npc.skill_ranks_get(toee.skill_knowledge_all)
		#result["Profession"] = self.npc.skill_ranks_get(toee.skill_profession)
		#result["Read Lips"] = self.npc.skill_ranks_get(toee.skill_read_lips)
		#result["Ride"] = self.npc.skill_ranks_get(toee.skill_ride)
		#result["Swim"] = self.npc.skill_ranks_get(toee.skill_swim)
		result["Use Rope"] = self.npc.skill_ranks_get(toee.skill_use_rope)
		return result
